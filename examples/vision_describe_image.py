...
# We MUST use a vision-capable model like 'llava'. 'llama3' will not work for images.
    ...
    messages=[
        {
            ...
            # A list of paths to image files. The model will analyze this file.
            "images": ["examples/images/image.jpg"],
        }
    ],
)
